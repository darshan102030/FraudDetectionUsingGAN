  ...
  import {   AlertTriangle, ChevronRight } from 'lucide-react'
    ...
    const handleVerifyUPI = async () => {
        ...
        try {
          ...
          if (querySnapshot.empty) {
            // Unregistered/real UPI IDs won't exist in our Firebase list, 
            // so we generate mock data to simulate the ML prediction instead.
            modelData = getRandomTransaction().model_processed;
          } else {
            // Get the first document from the query results
            const userDoc = querySnapshot.docs[0]; // Assuming UPI ID is unique
            modelData = userDoc.data().modelData;
          }
